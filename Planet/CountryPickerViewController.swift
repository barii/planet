...
public class CountryPickerViewController: UITableViewController {
    ...
    public var locale: Locale {
        ...
        set(newLocale) {
            countryDataSource = CountryDataSource(locale: newLocale, regions: regions)
            tableView.reloadData()
        }
    }
    
    public var regions: [Locale.Region] {
        get {
            return countryDataSource.regions
        }
        
        set(newLocale) {
            countryDataSource = CountryDataSource(locale: locale, regions: newLocale)
            tableView.reloadData()
        }
    }
